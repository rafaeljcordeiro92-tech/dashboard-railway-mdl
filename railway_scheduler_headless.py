# VERSAO: RAILWAY_SCHEDULER_MDL_V15_MONITOR_ORDEM_MAIN_SALES_RELOGIO
import json
import os
import sys
import time
...
STATE = {
    'version': 'V15_MONITOR_ORDEM_MAIN_SALES_RELOGIO',
    'started_at': None,
    'updated_at': None,
    'scheduler': 'starting',
