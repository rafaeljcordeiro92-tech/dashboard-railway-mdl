# VERSAO: RAILWAY_SCHEDULER_MDL_V28_TELEGRAM_IGNORA_GERENTES_META_VENDEDOR
import json
import os
import sys
import time
...
log('VERSAO V28: Telegram ignora GER/GERF nas metas individuais de vendedor; mantém filial, emojis, percentual e ZERO valores em reais')
